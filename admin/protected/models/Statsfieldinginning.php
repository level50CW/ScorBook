 ...
 * @property double $RF
 */
class Statsfieldinginning extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('Players_idplayer, Games_idgame, Lineup_idlineup, Inning, G, GS, INN, TC, PO, A, E, DP, SB, CS, PB, C_WP', 'numerical', 'integerOnly'=>true),
            array('SBPCT, FPCT, RF', 'numerical'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('Idstatsfield, Players_idplayer, Games_idgame, Lineup_idlineup, Inning, G, GS, INN, TC, PO, A, E, DP, SB, CS, SBPCT, PB, C_WP, FPCT, RF', 'safe', 'on'=>'search'),
        );
    }
