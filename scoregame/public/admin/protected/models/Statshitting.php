 ...
 */
class Statshitting extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Players_idplayer, Games_idgame, G, AB, R, H, v2B, v3B, HR, RBI, BB, SO, SB, CS, IBB, HBP, SAC, SF, TB, XBH, GDP, GO, AO, GO_AO, NP, PA', 'numerical', 'integerOnly'=>true),
			array('AVG, OBP, SLG, OPS', 'numerical'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idstatshit, Players_idplayer, Games_idgame, G, AB, R, H, v2B, v3B, HR, RBI, BB, SO, SB, CS, AVG, OBP, SLG, OPS, IBB, HBP, SAC, SF, TB, XBH, GDP, GO, AO, GO_AO, NP, PA', 'safe', 'on'=>'search'),
		);
	}
