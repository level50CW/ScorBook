 ...
 */
class Statspitching extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Players_idplayer, Games_idgame, W, L, G, GS, SV, SVO, H, R, ER, HR, BB, SO, CG, SHO, HB, IBB, GF, HLD, GIDP, GO, AO, WP, BK, SB, CS, PK, TBF, NP, WPCT, GO_AO, AB', 'numerical', 'integerOnly'=>true),
			array('ERA, AVG, WHIP, OBP, SLG, OPS, K_9, BB_9, K_BB, P_IP', 'numerical'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idstatspit, Players_idplayer, Games_idgame, W, L, ERA, G, GS, SV, SVO, IP, H, R, ER, HR, BB, SO, AVG, WHIP, CG, SHO, HB, IBB, GF, HLD, GIDP, GO, AO, WP, BK, SB, CS, PK, TBF, NP, WPCT, GO_AO, OBP, SLG, OPS, K_9, BB_9, K_BB, P_IP', 'safe', 'on'=>'search'),
		);
	}
